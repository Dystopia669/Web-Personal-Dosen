...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url() ?>assets/visitor/img/favicon.png" rel="icon">
    <link href="<?= base_url() ?>assets/visitor/img/apple-touch-icon.png" rel="apple-touch-icon">
        ...
        <div class="container">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li>
                        <button type="button" class="btn btn-success"><a class="nav-link <?= $this->uri->segment(1) == 'login' ? 'active' : '' ?> " href="<?= site_url('login') ?>">Login</a></button>
                    </li>
                </ul>
